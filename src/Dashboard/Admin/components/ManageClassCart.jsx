          ...
          <button
            ...
            className={`${
              status === "Approved" || status === "denied"
                ? "opacity-25 cursor-not-allowed"
                : ""
            } bg-main px-6 py-2 rounded m-1 text-sm block bg-[#1b1e34] text-white mx-auto`}
          >
            Denied
          </button>
          <button
            onClick={() => openFeed(_id)}
            className="block px-6 py-2 m-1 mx-auto text-sm rounded bg-[#1b1e34] text-white bg-main"
          >
            Send Feedback
          </button>
        </div>
