...
import ManageClassCard from '../components/ManageClassCart';
        ...
        <div className="mt-20">
            ...
            <div>
                <div className={`${isOpen ? "" : "hidden"} p-4 max-w-[700px] h-[300px] shadow-lg fixed z-[111111] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  rounded bg-white`}>
                    <form onSubmit={sendFeedback}>
                        ...
                        <div className='flex justify-center gap-3 mt-2 mb-3'>
                            <button className='px-4 py-2  rounded bg-lime-500'>Send</button>
                            <div onClick={() => setIsOpen(false)} className='px-4 py-2 bg-lime-500 rounded cursor-pointer '>close</div>
                        </div>
                    </form>
                </div>
                ...
                <section className='bg-white  h-[500px] mt-2 overflow-x-auto relative'>
                    <table className='w-full text-black table'>
                        <thead >
                            <tr className='bg-lime-500  sticky top-0 px-10'>
